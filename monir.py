...
logo =                                          """   
   ...
   \033[1;37m#     # ####### #     # ### #     #  
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           MONOR
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m        Łx Mõńír
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           lxŁx Mõńírbabu
...
def manual():
    try:
        token = open('/Łx Mõńír/tokenofl.txt', 'r').read()
        ...
        try:
            ...
            for j in q['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                with open('/Łx Mõńír/'+save_file, 'a') as rd:
...
def auto():
    ...
    try:
        access_token = open('/Łx Mõńír/tokenofl.txt', 'r').read()
    except:
        login()
    try:
    ...
    for fir in range(limit_user):
        ...
        try:
            tfile = open('/Łx Mõńír/tokenofl.txt','r').read()
    ...
    for ids in fileidopen:
        try:
            ...
            rgq = json.loads(rg)
            idsave=open('/Łx Mõńír/'+save_file, 'a')
           ...
           # print('  Total friends: '+str(len(uids)))
            ...
            if 'invalid' in str(rg):
                ...
                os.system('rm -rf temp*')
                pass
    lenid = open('/Łx Mõńír/'+save_file, 'r').readlines()
    print('  Grabbing Process has completed ')
    os.system('rm -rf temp*')
    print('  Total ids grabbed: '+str(len(lenid)))
    print('  File saved as: /Łx Mõńír/'+save_file)
    print(50*'-')
    input('  Press enter to back ')
    safraz()
